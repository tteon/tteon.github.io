...
- Tailwind CSS's preflight resets remove default margins on `<dd>` elements, allowing refactoring non-semantic tags without altering flex/grid visual layouts.
