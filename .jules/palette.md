...
Refactoring non-semantic tags to <dl> lists for key-value pair grids and adding tabindex="0" to <pre> blocks improves semantic structure and keyboard accessibility without changing visual output.
