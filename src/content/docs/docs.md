...
|---|---|---|
| Do I need a graph database for hello world? | Yes for the first-run CLI: configure a DozerDB/Neo4j Bolt endpoint and an existing database. | [Quickstart](/docs/quickstart/) |
